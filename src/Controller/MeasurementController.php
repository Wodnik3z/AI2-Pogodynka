...
use App\Form\MeasurementType; // Ensure this is the correct form type
...
class MeasurementController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $form = $this->createForm(MeasurementType::class, $measurement, [ // Ensure MeasurementType is used
